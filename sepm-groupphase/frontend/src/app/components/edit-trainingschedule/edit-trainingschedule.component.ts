...
@Component({
  selector: 'app-edit-trainingschedule',
  templateUrl: './edit-trainingschedule.component.html',
  styleUrls: ['./edit-trainingschedule.component.scss']
})
export class EditTrainingscheduleComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private findService: FindService, private workoutService: WorkoutService, private editTrainingScheduleService: EditTrainingScheduleService) { }
